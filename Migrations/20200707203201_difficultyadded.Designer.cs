...
namespace BeatSlayerServer.Migrations
{
    ...
    [Migration("20200707203201_difficultyadded")]
            ...
            modelBuilder.Entity("BeatSlayerServer.Models.Database.DifficultyInfo", b =>
                {
                    ...
                    b.HasOne("BeatSlayerServer.Models.Database.ReplayInfo", "Replays")
                        .WithMany()
                        .HasForeignKey("ReplaysId");
                });
