...
namespace BeatSlayerServer.Migrations
{
    ...
    [Migration("20200626191001_ProfileGrades")]
    partial class ProfileGrades
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatSlayerServer.Utils.Database.MapInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeatSlayerServer.Utils.Database.ReplayInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeatSlayerServer.Utils.Email.CodeVerificationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeatSlayerServer.Utils.Database.ReplayInfo", b =>
                {
                    b.HasOne("BeatSlayerServer.Utils.Database.MapInfo", "Map")
                        .WithMany("Replays")
                        .HasForeignKey("MapId")
